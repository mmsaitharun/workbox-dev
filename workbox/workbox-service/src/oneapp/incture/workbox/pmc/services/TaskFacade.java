...
import oneapp.incture.workbox.pmc.dto.AgingDataMapDto;
import oneapp.incture.workbox.pmc.dto.AgingHeaderMapDto;
...
public class TaskFacade implements TaskFacadeLocal {
	...
	public ManageTasksResponseDto getTasksByUserAndDuration(ManageTasksRequestDto request) {
		...
		try {
			...
			/*
			 * if (!ServicesUtil.isEmpty(request.getPage())) { int first = (request.getPage() - 1) * PMCConstant.PAGE_SIZE; int last = PMCConstant.PAGE_SIZE; query.setFirstResult(first);
